...
export default function Museums() {
  ...
  const handleReserveTicket = (sectionId) => {
    navigate(`/reserve/${museum.id}?section=${sectionId}`)
  }
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-card rounded-xl shadow-museum p-8 mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="flex items-center gap-2">
                  <span>🕒</span>
                  <span className="text-muted-foreground text-sm">{museum.opening_hours}</span>
                </div>
                <div className="flex items-center gap-2">
                  <span>💰</span>
                  <span className="text-muted-foreground text-sm">{museum.admission_price}</span>
                </div>
              </div>
            </div>
